...
const { useShoppingCart } = require("use-shopping-cart")

import { Button } from "@/components/ui/button"

export function CartSummary() {
  const { formattedTotalPrice, totalPrice , redirectToCheckout, cartCount, cartDetails } = useShoppingCart()
  const shippingAmount =  cartCount! > 0 ? 6000 : 0
